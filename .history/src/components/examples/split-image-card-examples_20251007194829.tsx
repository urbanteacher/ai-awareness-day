    ...
    <div className="space-y-8 p-8">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            <h4 className="text-lg font-medium mb-2">Small</h4>
            <SplitImageCard
              title="Quick AI Quiz"
              description="Test your basic AI knowledge"
              tags={['quiz', 'quick']}
              theme="smart"
              difficulty="beginner"
              size="small"
          ...
          <div>
            <h4 className="text-lg font-medium mb-2">Medium (Default)</h4>
            <SplitImageCard
              title="AI Workshop"
              description="Hands-on AI learning experience"
          ...
          <div>
            <h4 className="text-lg font-medium mb-2">Large</h4>
            <SplitImageCard
              title="Advanced AI Research Project"
              description="Comprehensive research into cutting-edge AI technologies"
              tags={['research', 'advanced', 'project']}
              theme="future"
              difficulty="advanced"
              size="large"
            />
