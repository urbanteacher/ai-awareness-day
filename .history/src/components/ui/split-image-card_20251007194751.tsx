...
export function SplitImageCard({
  ...
  return (
    <div 
      className={`bg-gray-800 p-0 border border-gray-600 hover:border-gray-500 transition-all duration-300 group cursor-pointer relative overflow-hidden flex flex-col hover:scale-105 hover:shadow-2xl ${currentSize.height} ${className}`}
      style={{
    ...
    >
      ...
      <div 
        className={`flex-1 bg-gradient-to-br ${currentTheme.gradient} ${currentSize.padding} relative overflow-hidden`}
      >
        ...
        <div className="relative z-10 mb-4">
          <div className={`w-full ${currentSize.imageHeight} bg-white/20 rounded-lg overflow-hidden backdrop-blur-sm`}>
            <img 
              src={imageUrl} 
              alt="AI Activity" 
        ...
        <div className="relative z-10 flex items-start justify-between">
          <h4 className={`${currentSize.titleSize} font-bold text-white leading-tight flex-1 mr-4`}>
      ...
      <div className={`bg-gray-800 ${currentSize.padding} flex-1 flex flex-col`}>
        {/* Description */}
