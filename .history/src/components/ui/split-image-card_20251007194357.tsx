    ...
    >
      ...
      >
        ...
        <div className="relative z-10 flex items-start gap-3">
          <h4 className="text-2xl font-bold text-white leading-tight flex-1 min-w-0">
            <span className="line-clamp-2">{title}</span>
          </h4>
          <span className={`px-2 py-1 text-xs font-medium rounded-full ${currentDifficulty} flex-shrink-0 mt-1`}>
