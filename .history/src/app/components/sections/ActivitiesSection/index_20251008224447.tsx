                ...
                >
                  ...
                  >
                    ...
                    <div className="relative z-10 mb-3 sm:mb-4">
                      {/* Mobile: Single line layout - Icon - Title - Duration */}
                      <div className="flex items-center space-x-2 sm:hidden mb-2">
                        <div 
                          className={`w-8 h-8 bg-gradient-to-r ${activity.color} flex items-center justify-center rounded-lg flex-shrink-0`}
                          style={{
