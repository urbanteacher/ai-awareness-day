            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              {activityTypes.map((activity, index) => (
                ...
                >
                  {/* Activity Card */}
                  <div 
                    className="bg-gray-800 dark:bg-gray-700 p-4 sm:p-6 hover:shadow-lg transition-all duration-300 relative overflow-hidden border-2 border-gray-600 dark:border-gray-500 group"
                    style={{
                  ...
                  >
                    ...
                    <div className="relative z-10 mb-3 sm:mb-4">
                      <div className="flex items-center justify-between mb-2 sm:mb-3">
                        ...
                        <span className="hidden sm:inline text-[10px] sm:text-xs font-bold text-white px-2 sm:px-3 py-1 rounded-full" style={{ backgroundColor: '#7c3aed' }}>
                          {activity.duration}
                        </span>
                      </div>
                      
                      <h3 className="text-base sm:text-lg font-semibold text-white mb-1 sm:mb-2">
                        <span className="sm:hidden">{activity.title} - {activity.duration}</span>
                    ...
                    <div className="space-y-1 sm:space-y-2">
                      ...
                      <div className="hidden sm:block space-y-2">
                        {activity.features.slice(2).map((feature, featureIndex) => (
                          <div key={featureIndex + 2} className="flex items-center space-x-2">
