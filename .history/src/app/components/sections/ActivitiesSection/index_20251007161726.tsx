                  ...
                  >
                    ...
                    <div 
                      ...
                      style={{
                        ...
                        backgroundImage: getThemeForType(activity.id)?.gradient
                      }}
                    />
                    ...
                    <div className="space-y-2">
                      {activity.features.map((feature, featureIndex) => (
                        <div key={featureIndex} className="flex items-center space-x-2">
                          <div className={`w-2 h-2 rounded-full`} style={{ backgroundColor: getThemeForType(activity.id)?.solidHex }} />
                    ...
                    >
                      <div className={`w-full h-full rounded-full`} style={{ backgroundImage: getThemeForType(activity.id)?.gradient }} />
                    </div>
                  </div>
                </motion.div>
              ))}
