              ...
              <Button
                ...
                className={`${
                  selectedTheme === theme.id
                    ...
                    : "border-gray-300 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:border-gray-600 dark:hover:bg-gray-800"
                }`}
              >
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-8">
                    ...
                    <div className="text-right">
                      <Badge className="text-lg px-4 py-2 text-white border-transparent hover:opacity-90" style={{ backgroundColor: '#7c3aed' }}>
                        {library.duration}
                      </Badge>
                    </div>
                  </div>
