...
export default function LibrarySection() {
  ...
  const getVisibleActivities = (library: any) => {
    ...
    // Show 4 activities on mobile, 3 on desktop initially
    const initialCount = window.innerWidth < 640 ? 4 : 3
    return isExpanded ? library.activities : library.activities.slice(0, initialCount)
  }
                        ...
                        <div className="flex justify-center mt-6 sm:mt-8">
                          ...
                          >
                            ...
                            <span className="sm:hidden">
                              {isExpanded ? "Less" : `More (${library.activities.length - 3})`}
                            </span>
                          </Button>
                        </div>
                      )}
