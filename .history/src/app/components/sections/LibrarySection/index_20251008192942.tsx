                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-8">
                    <div className="flex items-center space-x-4">
                      <div
                        className={`hidden sm:flex w-12 h-12 rounded-xl bg-gradient-to-br ${library.color} items-center justify-center`}
                      >
                        <library.icon className="w-6 h-6 text-white" />
                      </div>
                      <div>
                        <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground leading-tight h-12 sm:h-14 lg:h-16 flex items-center">
                    ...
                    <div className="text-right">
                      <Badge className="text-sm sm:text-base lg:text-lg px-2 sm:px-3 lg:px-4 py-1 sm:py-1.5 lg:py-2 text-white border-transparent hover:opacity-90 bg-purple-600 dark:bg-purple-500">
                        {library.duration}
                      </Badge>
                    </div>
                  </div>
