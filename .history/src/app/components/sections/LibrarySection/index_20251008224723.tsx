                    ...
                    <div className="flex items-center space-x-3 sm:space-x-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center space-x-3 mb-2">
                          ...
                          <Badge className="text-xs sm:text-sm lg:text-base px-2 sm:px-3 lg:px-4 py-1 sm:py-1.5 lg:py-2 text-white border-transparent hover:opacity-90 bg-purple-600 dark:bg-purple-500 flex-shrink-0">
                            {library.duration}
                          </Badge>
                        </div>
