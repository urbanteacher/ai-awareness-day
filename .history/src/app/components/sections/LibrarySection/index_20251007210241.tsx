                  ...
                  {visibleActivities.length > 0 ? (
                    <>
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div
                          key={activity.id}
                          className="bg-gray-800 p-0 border border-gray-600 transition-all duration-300 group cursor-pointer relative overflow-hidden flex flex-col hover:shadow-2xl"
                          style={{
