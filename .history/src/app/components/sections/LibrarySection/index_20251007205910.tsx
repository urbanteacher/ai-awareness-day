                    ...
                    <>
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        >
                          ...
                          <div className="flex flex-col h-full group-hover:scale-105 transition-transform duration-300">
                          ...
                          <div className={`bg-gradient-to-br ${
                            ...
                            {/* Title in theme section with difficulty star */}
                          ...
                          <div className="bg-gray-800 p-6 flex flex-col">
                            ...
                            <div className="flex-1">
                              <p className="text-white text-base leading-relaxed line-clamp-2 h-12 flex items-start">
