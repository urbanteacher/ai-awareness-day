...
export default function ToolsSection() {
  ...
  const getVisibleTools = (categoryTools: typeof teacherTools) => {
    ...
    // On desktop, always show all tools. On mobile, show only 2 unless expanded
    if (typeof window !== 'undefined' && window.innerWidth >= 640) {
      return categoryTools // Show all on desktop
    }
    return isExpanded ? categoryTools : categoryTools.slice(0, 2) // Mobile behavior
  }
  ...
  return (
    <Container>
      <div className="space-y-16">
          ...
          {categories.map((category) => {
            ...
            return (
              ...
              >
                ...
                <div 
                  className="bg-gradient-to-r from-purple-900 to-purple-950 text-white p-4 sm:p-6 relative overflow-hidden cursor-pointer"
                  style={{ 
        ...
        >
          <div 
            className="bg-gradient-to-r from-purple-900 to-purple-950 p-4 sm:p-8 text-white max-w-4xl mx-auto relative overflow-hidden"
            style={{ 
              clipPath: 'polygon(0 0, calc(100% - 20px) 0, 100% 20px, 100% 100%, 20px 100%, 0 calc(100% - 20px))' 
            }}
          >
