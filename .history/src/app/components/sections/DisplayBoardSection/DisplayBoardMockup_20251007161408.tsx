...
export default function DisplayBoardMockup() {
  const SAFE = themeConfigs.find(t => t.id === "safe")
  const SMART = themeConfigs.find(t => t.id === "smart")
  const CREATIVE = themeConfigs.find(t => t.id === "creative")
  const RESPONSIBLE = themeConfigs.find(t => t.id === "responsible")
  const FUTURE = themeConfigs.find(t => t.id === "future")
  return (
    <div className="w-full max-w-6xl mx-auto">
      ...
      <div className="bg-card border-4 border-gray-800 dark:border-gray-200 rounded-lg p-6 shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4 mb-8">
          ...
          {/* BE SAFE Panel */}
          <div className={`border-2 ${SAFE?.borderClass ?? ''} overflow-hidden`} 
               style={{ clipPath: 'polygon(0 0, calc(100% - 15px) 0, 100% 15px, 100% 100%, 15px 100%, 0 calc(100% - 15px))' }}>
            <div className={`${SAFE?.solidClass ?? ''} text-white p-4 text-center`}>
          ...
          {/* BE SMART Panel */}
          <div className={`border-2 ${SMART?.borderClass ?? ''} overflow-hidden`} 
               style={{ clipPath: 'polygon(0 0, calc(100% - 15px) 0, 100% 15px, 100% 100%, 15px 100%, 0 calc(100% - 15px))' }}>
            <div className={`${SMART?.solidClass ?? ''} text-white p-4 text-center`}>
              <div className="flex items-center justify-center gap-2 mb-2">
          ...
          {/* BE CREATIVE Panel */}
          <div className={`border-2 ${CREATIVE?.borderClass ?? ''} overflow-hidden`} 
               style={{ clipPath: 'polygon(0 0, calc(100% - 15px) 0, 100% 15px, 100% 100%, 15px 100%, 0 calc(100% - 15px))' }}>
            <div className={`${CREATIVE?.solidClass ?? ''} text-white p-4 text-center`}>
              <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <div className={`border-2 ${RESPONSIBLE?.borderClass ?? ''} overflow-hidden`} 
               style={{ clipPath: 'polygon(0 0, calc(100% - 15px) 0, 100% 15px, 100% 100%, 15px 100%, 0 calc(100% - 15px))' }}>
            <div className={`${RESPONSIBLE?.solidClass ?? ''} text-white p-4 text-center`}>
              <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <div className={`border-2 ${FUTURE?.borderClass ?? ''} overflow-hidden`} 
               style={{ clipPath: 'polygon(0 0, calc(100% - 15px) 0, 100% 15px, 100% 100%, 15px 100%, 0 calc(100% - 15px))' }}>
            <div className={`${FUTURE?.solidClass ?? ''} text-white p-4 text-center`}>
              <div className="flex items-center justify-center gap-2 mb-2">
