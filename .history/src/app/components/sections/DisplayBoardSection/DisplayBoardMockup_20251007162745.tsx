    ...
    <div className="w-full max-w-6xl mx-auto">
      ...
      <div className="bg-card border-4 border-gray-800 dark:border-gray-200 rounded-lg p-6 shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4 mb-8">
          ...
          {/* BE SAFE Panel */}
          <div className="border-2 border-red-700 overflow-hidden" 
          ...
          {/* BE SMART Panel */}
          <div className="border-2 border-blue-700 overflow-hidden" 
               style={{ clipPath: 'polygon(0 0, calc(100% - 15px) 0, 100% 15px, 100% 100%, 15px 100%, 0 calc(100% - 15px))' }}>
          ...
          <div className="border-2 border-purple-700 overflow-hidden" 
               style={{ clipPath: 'polygon(0 0, calc(100% - 15px) 0, 100% 15px, 100% 100%, 15px 100%, 0 calc(100% - 15px))' }}>
          ...
          <div className="border-2 border-orange-700 overflow-hidden" 
               style={{ clipPath: 'polygon(0 0, calc(100% - 15px) 0, 100% 15px, 100% 100%, 15px 100%, 0 calc(100% - 15px))' }}>
