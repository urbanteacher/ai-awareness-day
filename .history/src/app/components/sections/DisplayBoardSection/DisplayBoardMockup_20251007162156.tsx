      ...
      <div className="bg-card border-4 border-gray-800 dark:border-gray-200 rounded-lg p-6 shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4 mb-8">
          ...
          <div className={`border-2 overflow-hidden`} 
               style={{ borderColor: SAFE?.borderHex }}
               style={{ clipPath: 'polygon(0 0, calc(100% - 15px) 0, 100% 15px, 100% 100%, 15px 100%, 0 calc(100% - 15px))' }}>
            <div className={`text-white p-4 text-center`} style={{ backgroundColor: SAFE?.solidHex }}>
          ...
          {/* BE SMART Panel */}
          <div className={`border-2 overflow-hidden`} 
               style={{ borderColor: SMART?.borderHex }}
               style={{ clipPath: 'polygon(0 0, calc(100% - 15px) 0, 100% 15px, 100% 100%, 15px 100%, 0 calc(100% - 15px))' }}>
            <div className={`text-white p-4 text-center`} style={{ backgroundColor: SMART?.solidHex }}>
              <div className="flex items-center justify-center gap-2 mb-2">
          ...
          {/* BE CREATIVE Panel */}
          <div className={`border-2 overflow-hidden`} 
               style={{ borderColor: CREATIVE?.borderHex }}
               style={{ clipPath: 'polygon(0 0, calc(100% - 15px) 0, 100% 15px, 100% 100%, 15px 100%, 0 calc(100% - 15px))' }}>
            <div className={`text-white p-4 text-center`} style={{ backgroundColor: CREATIVE?.solidHex }}>
              <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <div className={`border-2 overflow-hidden`} 
               style={{ borderColor: RESPONSIBLE?.borderHex }}
               style={{ clipPath: 'polygon(0 0, calc(100% - 15px) 0, 100% 15px, 100% 100%, 15px 100%, 0 calc(100% - 15px))' }}>
            <div className={`text-white p-4 text-center`} style={{ backgroundColor: RESPONSIBLE?.solidHex }}>
              <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <div className={`border-2 overflow-hidden`} 
               style={{ borderColor: FUTURE?.borderHex }}
               style={{ clipPath: 'polygon(0 0, calc(100% - 15px) 0, 100% 15px, 100% 100%, 15px 100%, 0 calc(100% - 15px))' }}>
            <div className={`text-white p-4 text-center`} style={{ backgroundColor: FUTURE?.solidHex }}>
              <div className="flex items-center justify-center gap-2 mb-2">
