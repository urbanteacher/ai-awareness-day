...
export default function DisplayBoardMockup() {
  return (
    <div className="w-full max-w-7xl mx-auto">
      ...
      <div className="bg-transparent border-2 sm:border-4 border-black dark:border-white p-4 sm:p-8 shadow-2xl relative overflow-hidden">
        <div 
        ...
        <div className="relative mb-12">
          <div className="bg-blue-600 text-white p-4 sm:p-8 shadow-xl border-2 sm:border-4 border-black dark:border-white relative overflow-hidden">
            <div 
              className="w-full h-full"
              style={{
            ...
            <div className="text-center">
              <div className="flex items-center justify-center gap-6 mb-6">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm sm:text-xl opacity-90 font-medium">Know it, Question it, Use it Wisely</p>
                </div>
              </div>
            </div>
            </div>
