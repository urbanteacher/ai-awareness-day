    ...
    <div className="w-full max-w-7xl mx-auto">
      ...
      <div className="bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-800 dark:to-slate-900 border-4 border-black dark:border-white rounded-3xl p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white rounded-2xl shadow-lg border-2 border-black hover:border-yellow-400 transition-all duration-300 overflow-hidden">
          ...
          <div className="bg-white rounded-2xl shadow-lg border-2 border-black hover:border-green-400 transition-all duration-300 overflow-hidden">
        ...
        <div className="bg-white rounded-2xl shadow-lg border-2 border-black hover:border-indigo-400 transition-all duration-300 overflow-hidden mb-8">
         ...
         <div className="bg-white rounded-2xl shadow-lg border-2 border-black hover:border-purple-400 transition-all duration-300 overflow-hidden mb-8">
