    ...
    <div className="w-full max-w-7xl mx-auto">
      ...
      <div className="bg-gradient-to-br from-slate-50 to-blue-50 border-4 border-slate-300 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative mb-12">
          <div className="bg-blue-600 text-white rounded-2xl p-8 shadow-xl border-4 border-white/20 relative overflow-hidden">
              ...
              <div className="space-y-4">
                <div className="bg-gradient-to-r from-red-50 to-pink-50 p-4 rounded-xl border-l-4 border-red-400">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <p className="text-sm font-semibold text-red-800">BE SAFE</p>
                  </div>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-xl border-l-4 border-blue-400">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <p className="text-sm font-semibold text-blue-800">BE SMART</p>
                  </div>
                ...
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-4 rounded-xl border-l-4 border-green-400">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <p className="text-sm font-semibold text-green-800">BE CREATIVE</p>
                  </div>
        ...
        {/* AI Leaders Gallery - Modern Design */}
        <div className="bg-white rounded-2xl shadow-lg border-2 border-indigo-200 hover:border-indigo-400 transition-all duration-300 overflow-hidden mb-8">
          ...
          <div className="p-6 bg-gradient-to-br from-gray-50 to-white">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
              ...
              <div className="bg-gradient-to-br from-gray-100 to-gray-200 p-4 rounded-xl border-2 border-dashed border-gray-300 text-center hover:border-indigo-400 transition-colors">
                <div className="w-16 h-16 bg-gradient-to-br from-indigo-100 to-purple-100 rounded-full mx-auto mb-3 flex items-center justify-center">
            ...
            <div className="bg-gradient-to-r from-indigo-50 to-purple-50 p-4 rounded-xl border-l-4 border-indigo-400">
         ...
         {/* Student Spotlight - Modern Design */}
         <div className="bg-white rounded-2xl shadow-lg border-2 border-purple-200 hover:border-purple-400 transition-all duration-300 overflow-hidden mb-8">
           ...
           <div className="p-6 bg-gradient-to-br from-gray-50 to-white">
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
               <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-4 rounded-xl border-l-4 border-purple-400">
