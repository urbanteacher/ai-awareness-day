      ...
      <div className="bg-card border-4 border-gray-800 dark:border-gray-200 rounded-lg p-6 shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4 mb-8">
          ...
          <div className="border-2 border-red-500 overflow-hidden" 
            ...
            <div className="bg-gradient-to-br from-red-500 to-red-600 text-white p-4 text-center">
          ...
          <div className="border-2 border-blue-500 overflow-hidden" 
               style={{ clipPath: 'polygon(0 0, calc(100% - 15px) 0, 100% 15px, 100% 100%, 15px 100%, 0 calc(100% - 15px))' }}>
            <div className="bg-gradient-to-br from-blue-500 to-blue-600 text-white p-4 text-center">
              <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <div className="border-2 border-green-500 overflow-hidden" 
               style={{ clipPath: 'polygon(0 0, calc(100% - 15px) 0, 100% 15px, 100% 100%, 15px 100%, 0 calc(100% - 15px))' }}>
            <div className="bg-gradient-to-br from-green-500 to-green-600 text-white p-4 text-center">
              <div className="flex items-center justify-center gap-2 mb-2">
