...
import { themeTw } from "@/data/themes";
    ...
    <div className="w-full max-w-6xl mx-auto">
      ...
      <div className="bg-card border-4 border-gray-800 dark:border-gray-200 rounded-lg p-6 shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4 mb-8">
          ...
          {/* BE SAFE Panel */}
          <div className={`border-2 ${themeTw.safe.border} overflow-hidden`} 
               style={{ clipPath: 'polygon(0 0, calc(100% - 15px) 0, 100% 15px, 100% 100%, 15px 100%, 0 calc(100% - 15px))' }}>
            <div className={`${themeTw.safe.headerBg} text-white p-4 text-center`}>
          ...
          {/* BE SMART Panel */}
          <div className={`border-2 ${themeTw.smart.border} overflow-hidden`} 
               style={{ clipPath: 'polygon(0 0, calc(100% - 15px) 0, 100% 15px, 100% 100%, 15px 100%, 0 calc(100% - 15px))' }}>
            <div className={`${themeTw.smart.headerBg} text-white p-4 text-center`}>
              <div className="flex items-center justify-center gap-2 mb-2">
          ...
          {/* BE CREATIVE Panel */}
          <div className={`border-2 ${themeTw.creative.border} overflow-hidden`} 
               style={{ clipPath: 'polygon(0 0, calc(100% - 15px) 0, 100% 15px, 100% 100%, 15px 100%, 0 calc(100% - 15px))' }}>
            <div className={`${themeTw.creative.headerBg} text-white p-4 text-center`}>
              <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <div className={`border-2 ${themeTw.responsible.border} overflow-hidden`} 
               style={{ clipPath: 'polygon(0 0, calc(100% - 15px) 0, 100% 15px, 100% 100%, 15px 100%, 0 calc(100% - 15px))' }}>
            <div className={`${themeTw.responsible.headerBg} text-white p-4 text-center`}>
              <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <div className={`border-2 ${themeTw.future.border} overflow-hidden`} 
               style={{ clipPath: 'polygon(0 0, calc(100% - 15px) 0, 100% 15px, 100% 100%, 15px 100%, 0 calc(100% - 15px))' }}>
            <div className={`${themeTw.future.headerBg} text-white p-4 text-center`}>
              <div className="flex items-center justify-center gap-2 mb-2">
