    ...
    <div className="w-full max-w-7xl mx-auto">
      ...
      <div className="bg-gradient-to-br from-slate-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 border-4 border-black dark:border-gray-600 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative mb-12">
          <div className="bg-blue-600 text-white rounded-2xl p-8 shadow-xl border-4 border-black dark:border-gray-600 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          ...
          <div className="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border-2 border-black dark:border-gray-600 hover:border-red-400">
            {/* Header */}
          ...
          <div className="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border-2 border-black dark:border-gray-600 hover:border-blue-400">
            {/* Header */}
          ...
          <div className="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border-2 border-black dark:border-gray-600 hover:border-green-400">
            {/* Header */}
          ...
          <div className="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border-2 border-black dark:border-gray-600 hover:border-purple-400">
            {/* Header */}
          ...
          <div className="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border-2 border-black dark:border-gray-600 hover:border-orange-400">
            {/* Header */}
          ...
          <div className="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border-2 border-black dark:border-gray-600 hover:border-cyan-400">
            {/* Header */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border-2 border-black dark:border-gray-600 hover:border-yellow-400 transition-all duration-300 overflow-hidden">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border-2 border-black dark:border-gray-600 hover:border-green-400 transition-all duration-300 overflow-hidden">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border-2 border-black dark:border-gray-600 hover:border-indigo-400 transition-all duration-300 overflow-hidden mb-8">
         ...
         <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border-2 border-black dark:border-gray-600 hover:border-purple-400 transition-all duration-300 overflow-hidden mb-8">
