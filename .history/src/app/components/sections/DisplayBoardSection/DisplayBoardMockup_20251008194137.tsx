          ...
          >
            ...
            <div className="p-4 bg-white dark:bg-gray-800">
              ...
              <div className="flex items-center gap-2">
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400">AI can process information 1 million times faster than humans!</p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="p-4 bg-white dark:bg-gray-800">
              ...
              <div className="flex items-center gap-2">
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400">ChatGPT was trained on 45TB of text data!</p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="p-4 bg-white dark:bg-gray-800">
              ...
              <div className="flex items-center gap-2">
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400">AI can recognize patterns humans miss!</p>
              </div>
            </div>
          </div>
