              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <div className={`${
                      section.color === 'bg-blue-500' ? 'bg-gradient-to-r from-blue-600 to-blue-500' :
                      section.color === 'bg-green-500' ? 'bg-gradient-to-r from-green-600 to-green-500' :
                      section.color === 'bg-purple-500' ? 'bg-gradient-to-r from-purple-600 to-purple-500' :
                      section.color === 'bg-pink-500' ? 'bg-gradient-to-r from-pink-600 to-pink-500' :
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className={`${
                            section.color === 'bg-blue-500' ? 'text-blue-100' :
                            section.color === 'bg-green-500' ? 'text-green-100' :
                            section.color === 'bg-purple-500' ? 'text-purple-100' :
                            section.color === 'bg-pink-500' ? 'text-pink-100' :
                            'text-blue-100'
