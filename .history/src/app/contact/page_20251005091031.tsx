      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-200 max-w-3xl mx-auto">
            Have questions about the AI Awareness Day campaign? We're here to help! Send us a message and we'll get back to you as soon as possible.
          </p>
        </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-200">info@aiawarenessday.co.uk</p>
