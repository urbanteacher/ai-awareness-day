      ...
      <main>
        ...
        <SectionWrapper className="bg-card">
          <Container>
            ...
            {/* Mobile: Show simplified polygon info */}
            <div className="block sm:hidden">
              <div className="space-y-3">
                <div className="bg-muted/30 p-4 rounded-lg">
                  <h4 className="font-medium mb-2">Small Polygon</h4>
                  <p className="text-sm text-muted-foreground">128px × 128px (w-32 h-32)</p>
                </div>
                <div className="bg-muted/30 p-4 rounded-lg">
                  <h4 className="font-medium mb-2">Medium Polygon</h4>
                  <p className="text-sm text-muted-foreground">160px × 160px (w-40 h-40)</p>
                </div>
                <div className="bg-muted/30 p-4 rounded-lg">
                  <h4 className="font-medium mb-2">Large Polygon</h4>
                  <p className="text-sm text-muted-foreground">192px × 192px (w-48 h-48)</p>
                </div>
              </div>
            </div>

            {/* Desktop: Show detailed table */}
            <div className="hidden sm:block overflow-x-auto -mx-4 sm:mx-0">
              <table className="w-full border-collapse min-w-[400px]">
                <thead>
                  <tr className="border-b">
                    <th className="text-left p-2 sm:p-3 font-semibold text-sm">Size Variant</th>
                    <th className="text-left p-2 sm:p-3 font-semibold text-sm">Dimensions</th>
                    <th className="text-left p-2 sm:p-3 font-semibold text-sm">Pixels</th>
                    <th className="text-left p-2 sm:p-3 font-semibold text-sm">Class</th>
                  </tr>
                </thead>
                <tbody>
                  {polygonSpecs.map((spec, index) => (
                    <tr key={index} className="border-b">
                      <td className="p-2 sm:p-3 font-medium text-sm">{spec.variant}</td>
                      <td className="p-2 sm:p-3 text-muted-foreground text-sm">{spec.dimensions}</td>
                      <td className="p-2 sm:p-3 text-muted-foreground font-mono text-xs">{spec.pixels}</td>
                      <td className="p-2 sm:p-3 text-muted-foreground font-mono text-xs bg-muted/50 rounded px-1 sm:px-2">{spec.class}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <SectionWrapper className="bg-white dark:bg-gray-800">
          <Container>
            ...
            <div className="mb-12">
              <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6">Library Section Activity Cards (Old Version)</h3>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8">
                {/* Sample Activity Card */}
                <div className="bg-gray-800 p-4 sm:p-6 border border-gray-600 group cursor-pointer relative overflow-hidden h-72 sm:h-80 flex flex-col"
                     style={{
            ...
            <div className="mb-12">
              <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6">Activities Section Cards</h3>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8">
                {/* Sample Activity Type Card */}
                <div className="group relative overflow-hidden rounded-lg border bg-card p-4 sm:p-6">
        ...
        <SectionWrapper className="bg-white dark:bg-gray-800">
          <Container>
            ...
            {/* Live Examples */}
            <div className="mb-12">
              <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6">Live Examples - All Themes</h3>
              
              {/* Mobile: Show only 2 examples */}
              <div className="block sm:hidden grid grid-cols-1 gap-6 mb-8">
                <SplitImageCard
                  theme="smart"
              ...
              {/* Desktop: Show all examples */}
              <div className="hidden sm:grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-8">
                <SplitImageCard
                  theme="smart"
                  title="AI in Daily Life"
                  description="Discuss how AI is already part of students' daily routines and explore the technology they use every day."
            ...
            <div className="mb-12">
              <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6">Design Specifications</h3>
              
              {/* Mobile: Show simplified version */}
              <div className="block sm:hidden">
                <div className="space-y-4">
                  <div className="bg-muted/30 p-4 rounded-lg">
                    <h4 className="font-medium mb-2">Theme Section</h4>
                    <p className="text-sm text-muted-foreground">Gradient background, image overlay, theme indicator, title, and difficulty badge</p>
                  </div>
                  <div className="bg-muted/30 p-4 rounded-lg">
                    <h4 className="font-medium mb-2">Content Section</h4>
                    <p className="text-sm text-muted-foreground">Description, tags, and view details link</p>
                  </div>
                </div>
              </div>
              
              {/* Desktop: Show detailed version */}
              <div className="hidden sm:grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                {/* Theme Section Specs */}
                <div className="space-y-4">
            ...
            {/* Theme Configuration */}
            <div className="mb-12">
              <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6">Theme Configuration</h3>
              
              {/* Mobile: Show simplified theme info */}
              <div className="block sm:hidden">
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    <div className="w-3 h-3 rounded-full bg-red-500"></div>
                    <span className="text-sm font-medium">Safe - Red Theme</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-3 h-3 rounded-full bg-blue-500"></div>
                    <span className="text-sm font-medium">Smart - Blue Theme</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-3 h-3 rounded-full bg-green-500"></div>
                    <span className="text-sm font-medium">Creative - Green Theme</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-3 h-3 rounded-full bg-purple-500"></div>
                    <span className="text-sm font-medium">Responsible - Purple Theme</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-3 h-3 rounded-full bg-orange-500"></div>
                    <span className="text-sm font-medium">Future - Orange Theme</span>
                  </div>
                </div>
              </div>
              ...
              <table className="w-full border-collapse min-w-[600px]">
                <thead>
                  <tr className="border-b">
                    <th className="text-left p-2 sm:p-3 font-semibold text-sm">Theme</th>
                    <th className="text-left p-2 sm:p-3 font-semibold text-sm">Gradient</th>
                    <th className="text-left p-2 sm:p-3 font-semibold text-sm">Label</th>
                    <th className="text-left p-2 sm:p-3 font-semibold text-sm">Dot Color</th>
                    <th className="text-left p-2 sm:p-3 font-semibold text-sm">Difficulty Color</th>
                  </tr>
                </thead>
                  <tbody>
                    <tr className="border-b">
                      <td className="p-2 sm:p-3 font-medium text-sm">Safe</td>
                      <td className="p-2 sm:p-3 text-muted-foreground font-mono text-xs">from-red-500 to-red-600</td>
                      <td className="p-2 sm:p-3 text-muted-foreground text-sm">BE SAFE</td>
                      <td className="p-2 sm:p-3 text-muted-foreground font-mono text-xs">bg-red-500</td>
                      <td className="p-2 sm:p-3 text-muted-foreground font-mono text-xs">red-100/red-800</td>
                    </tr>
                    <tr className="border-b">
                      <td className="p-2 sm:p-3 font-medium text-sm">Smart</td>
                      <td className="p-2 sm:p-3 text-muted-foreground font-mono text-xs">from-blue-500 to-blue-600</td>
                      <td className="p-2 sm:p-3 text-muted-foreground text-sm">BE SMART</td>
                      <td className="p-2 sm:p-3 text-muted-foreground font-mono text-xs">bg-blue-500</td>
                      <td className="p-2 sm:p-3 text-muted-foreground font-mono text-xs">green-100/green-800</td>
                    </tr>
                    <tr className="border-b">
                      <td className="p-2 sm:p-3 font-medium text-sm">Creative</td>
                      <td className="p-2 sm:p-3 text-muted-foreground font-mono text-xs">from-green-500 to-green-600</td>
                      <td className="p-2 sm:p-3 text-muted-foreground text-sm">BE CREATIVE</td>
                      <td className="p-2 sm:p-3 text-muted-foreground font-mono text-xs">bg-green-500</td>
                      <td className="p-2 sm:p-3 text-muted-foreground font-mono text-xs">yellow-100/yellow-800</td>
                    </tr>
                    <tr className="border-b">
                      <td className="p-2 sm:p-3 font-medium text-sm">Responsible</td>
                      <td className="p-2 sm:p-3 text-muted-foreground font-mono text-xs">from-purple-500 to-purple-600</td>
                      <td className="p-2 sm:p-3 text-muted-foreground text-sm">BE RESPONSIBLE</td>
                      <td className="p-2 sm:p-3 text-muted-foreground font-mono text-xs">bg-purple-500</td>
                      <td className="p-2 sm:p-3 text-muted-foreground font-mono text-xs">orange-100/orange-800</td>
                    </tr>
                    <tr className="border-b">
                      <td className="p-2 sm:p-3 font-medium text-sm">Future</td>
                      <td className="p-2 sm:p-3 text-muted-foreground font-mono text-xs">from-orange-500 to-orange-600</td>
                      <td className="p-2 sm:p-3 text-muted-foreground text-sm">BE FUTURE</td>
                      <td className="p-2 sm:p-3 text-muted-foreground font-mono text-xs">bg-orange-500</td>
                      <td className="p-2 sm:p-3 text-muted-foreground font-mono text-xs">blue-100/blue-800</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            {/* Usage Guidelines */}
            <div className="mb-12">
              <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6">Usage Guidelines</h3>
        ...
        <SectionWrapper className="bg-gray-50 dark:bg-gray-900">
          <Container>
            ...
            <div className="block sm:hidden">
              <div className="space-y-4">
                <div className="bg-muted/30 p-4 rounded-lg">
                  <h4 className="font-medium mb-2">Shape Type</h4>
                  <p className="text-sm text-muted-foreground">6-sided polygon (hexagonal with chamfered corners)</p>
                </div>
                <div className="bg-muted/30 p-4 rounded-lg">
                  <h4 className="font-medium mb-2">Format</h4>
                  <p className="text-sm text-muted-foreground">SVG with linearGradient definitions</p>
                </div>
                <div className="bg-muted/30 p-4 rounded-lg">
                  <h4 className="font-medium mb-2">Scalability</h4>
                  <p className="text-sm text-muted-foreground">Vector format - infinitely scalable</p>
                </div>
              </div>
            </div>
        ...
        <SectionWrapper className="bg-gradient-to-br from-blue-50 to-purple-50">
          <Container>
            <div className="text-center space-y-6">
              <SectionHeader
                title="🎨 Interactive Design Demo"
                description="Test different design variations, typography, layouts, and colors in real-time"
                titleColor="purple"
                align="center"
              />
              ...
              <p className="text-sm text-muted-foreground max-w-2xl mx-auto">
                Experiment with different design variations, customize content, and generate code for your AI awareness projects.
              </p>
            </div>
          </Container>
        </SectionWrapper>
