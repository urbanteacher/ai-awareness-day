...
const colorPalette = [
  ...
  },
  {
    name: "Card Bottom",
    hex: "#1f2937",
    usage: "Polygon card bottom section"
  }
]
          ...
          <Container>
            ...
            <div className="relative p-16 bg-muted/30 rounded-xl flex justify-center items-center">
              <div className="relative">
                ...
                {/* Annotations */}
                <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 bg-white px-3 py-1 rounded shadow-lg text-sm font-semibold">
                  Width: 160px (Medium)
                </div>
                <div className="absolute -right-16 top-1/2 transform -translate-y-1/2 bg-white px-3 py-1 rounded shadow-lg text-sm font-semibold">
                  Height: 160px
                </div>
                <div className="absolute -bottom-12 left-1/2 transform -translate-x-1/2 bg-white px-3 py-1 rounded shadow-lg text-sm font-semibold">
                  25% Corner Cuts
                </div>
                <div className="absolute -left-16 top-1/2 transform -translate-y-1/2 bg-white px-3 py-1 rounded shadow-lg text-sm font-semibold">
                  SVG Polygon
                </div>
              </div>
            </div>
