...
const cardVariations = [
  ...
  {
    name: "Split + Description Below",
    description: "Split design with description below the main card"
  }
]
                ...
                <div className={`grid ${currentLayout.layout} ${currentLayout.gap} ${currentLayout.alignment}`}>
                  ...
                  {designState.cardVariation === 10 && (
                    ...
                    <div className="bg-gray-800 p-0 border border-gray-600 hover:border-gray-500 transition-all duration-300 group cursor-pointer relative overflow-hidden flex hover:scale-105 hover:shadow-2xl"
                      ...
                      <div 
                        className={`w-1/2 bg-gradient-to-br ${cardThemes[designState.selectedTheme].gradient} p-6 relative overflow-hidden flex flex-col`}
                      >
                  ...
                  {designState.cardVariation === 11 && (
                    // Split + Description Below Card
                    <div className="space-y-4">
                      {/* Main Split Card */}
                      <div className="bg-gray-800 p-0 border border-gray-600 hover:border-gray-500 transition-all duration-300 group cursor-pointer relative overflow-hidden flex hover:scale-105 hover:shadow-2xl"
                           style={{
                        ...
                        {/* Right side - Tags and View Details */}
                        <div className="w-1/2 bg-gray-800 p-6 flex flex-col justify-between">
        ...
        <SectionWrapper className="bg-gray-50 dark:bg-gray-900">
          <Container>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              {/* Split + Image Card */}
              <SectionCard className="overflow-hidden">
                <div className="bg-gray-800 p-0 border border-gray-600 hover:border-gray-500 transition-all duration-300 group cursor-pointer relative overflow-hidden flex hover:scale-105 hover:shadow-2xl h-96">
                  {/* Left side - Theme section with image */}
                  <div className="w-1/2 bg-gradient-to-br from-purple-500 to-pink-500 p-6 relative overflow-hidden flex flex-col">
                    {/* Background image overlay */}
                    <div 
                      className="absolute inset-0 bg-cover bg-center opacity-20 group-hover:opacity-30 transition-opacity duration-300"
                      style={{
                    ...
                    {/* Title in theme section with difficulty badge */}
                    <div className="relative z-10 flex items-start justify-between">
                      <h4 className="text-lg font-bold text-white leading-tight flex-1 mr-4">
                        <span className="line-clamp-2">Split + Image Design</span>
                      </h4>
                      <span className="px-2 py-1 text-xs font-medium rounded-full bg-green-100 text-green-800 flex-shrink-0">Beginner</span>
                    </div>
                  </div>
                  ...
                  <div className="w-1/2 bg-gray-800 p-6 flex flex-col">
                    ...
                    <div className="flex-1">
                      <p className="text-white text-base leading-relaxed line-clamp-3 h-16 flex items-start">
                        <span className="line-clamp-3">Split design combined with image content inside</span>
                      </p>
                    </div>
              ...
              <SectionCard className="overflow-hidden">
                <div className="space-y-4">
                  {/* Main Split Card */}
                  <div className="bg-gray-800 p-0 border border-gray-600 hover:border-gray-500 transition-all duration-300 group cursor-pointer relative overflow-hidden flex hover:scale-105 hover:shadow-2xl h-80">
                    {/* Left side - Theme section with image */}
                    <div className="w-1/2 bg-gradient-to-br from-purple-500 to-pink-500 p-6 relative overflow-hidden flex flex-col">
                      {/* Background image overlay */}
                      <div 
                      ...
                      <div className="relative z-10 flex items-start justify-between">
                        <h4 className="text-lg font-bold text-white leading-tight flex-1 mr-4">
                          <span className="line-clamp-2">Split + Description Below</span>
                        </h4>
                        <span className="px-2 py-1 text-xs font-medium rounded-full bg-green-100 text-green-800 flex-shrink-0">Beginner</span>
                      </div>
                    </div>
                  ...
                  <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                    <p className="text-gray-800 dark:text-white text-base leading-relaxed">
                      Split design with description below the main card
                    </p>
                  </div>
                </div>
                <div className="p-4">
                  <h4 className="font-semibold mb-2">Split + Description Below (Purple)</h4>
                  <p className="text-sm text-muted-foreground">Split design with description below the main card</p>
                </div>
              </SectionCard>
            </div>
          </Container>
