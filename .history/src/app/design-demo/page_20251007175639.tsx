                  ...
                  {designState.cardVariation === 10 && (
                    ...
                    <div className="bg-gray-800 p-0 border border-gray-600 hover:border-gray-500 transition-all duration-300 group cursor-pointer relative overflow-hidden flex flex-col hover:scale-105 hover:shadow-2xl"
                      ...
                      <div className="bg-gray-800 p-6 flex-1 flex flex-col">
                        ...
                        {/* Description */}
                        <div className="flex-1">
                          <p className={`text-white text-sm leading-relaxed line-clamp-3 h-16 flex items-start`}>
              ...
              <SectionCard className="overflow-hidden">
                <div className="bg-gray-800 p-0 border border-gray-600 hover:border-gray-500 transition-all duration-300 group cursor-pointer relative overflow-hidden flex flex-col hover:scale-105 hover:shadow-2xl h-96">
                  ...
                  <div className="bg-gray-800 p-6 flex-1 flex flex-col">
                    ...
                    {/* Description */}
                    <div className="flex-1">
                      <p className="text-white text-lg leading-relaxed line-clamp-3 h-16 flex items-start">
