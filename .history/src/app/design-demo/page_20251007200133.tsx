            ...
            <div className="relative p-20 rounded-xl overflow-hidden">
              <div className="relative">
                <div className="grid grid-cols-1 gap-8 items-start">
                  {/* Split + Image Card */}
                  <div className="bg-gray-800 p-0 border border-gray-600 hover:border-gray-500 transition-all duration-300 group cursor-pointer relative overflow-hidden flex flex-row hover:scale-105 hover:shadow-2xl h-96"
                       style={{
                         clipPath: "polygon(0 0, calc(100% - 50px) 0, 100% 50px, 100% 100%, 50px 100%, 0 calc(100% - 50px))"
                       }}>
                    
                    {/* Left side - Theme section with image */}
                    <div className="w-1/2 bg-gradient-to-br from-blue-500 to-blue-600 p-6 relative overflow-hidden flex flex-col">
                      ...
                      <div className="relative z-10 flex items-start justify-between mt-auto">
                        <h4 className="text-2xl font-bold text-white leading-tight flex-1 mr-4">
                          <span className="line-clamp-2">AI in Daily Life</span>
                        </h4>
                        <span className="px-2 py-1 text-xs font-medium rounded-full bg-green-500/20 text-green-300 border border-green-400/30 flex-shrink-0">
                          Beginner
                        </span>
                      </div>
                    </div>
