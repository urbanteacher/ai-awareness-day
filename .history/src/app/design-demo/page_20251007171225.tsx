...
const typographyVariants = [
  {
    ...
    taglineSize: "text-3xl md:text-4xl",
...
export default function DesignDemoPage() {
  const [designState, setDesignState] = useState<DesignState>({
    selectedColors: ['blue', 'purple', 'green'],
    typographyVariant: 2,
    layoutVariant: 0,
    backgroundVariant: 0,
    showPolygons: true,
    polygonSize: 'medium',
    customTitle: 'AI AWARENESS DAY',
    customTagline: 'Know it, Question it, Use it Wisely',
    customDescription: 'A nationwide campaign equipping students with critical AI skills through engaging activities, ethical discussions, and creative challenges.'
  })
