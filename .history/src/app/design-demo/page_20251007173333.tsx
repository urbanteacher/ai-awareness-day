                    ...
                    <div className="bg-gray-800 p-6 border border-gray-600 hover:border-gray-500 transition-all duration-300 group cursor-pointer relative overflow-hidden flex flex-col hover:scale-105 hover:shadow-2xl"
                      ...
                      <div className="relative z-10 flex items-start justify-between mb-6">
                        <div className="flex items-center space-x-3">
                          <div className={`w-4 h-4 rounded-full ${cardThemes[designState.selectedTheme].dotColor} shadow-sm`} />
                          <div className="flex flex-col">
                            <span className="text-sm font-semibold text-white">{cardThemes[designState.selectedTheme].theme}</span>
                            <span className="text-xs text-gray-400">General</span>
                          </div>
                        </div>
                        <span className={`px-3 py-1.5 text-xs font-semibold rounded-full ${difficultyLevels[designState.difficultyLevel].className} shadow-sm`}>
                      ...
                      <div className="relative z-10 flex-1 flex flex-col space-y-4">
                        ...
                        <div className="space-y-3">
                          ...
                          <p className={`text-gray-300 ${cardSizes[designState.cardSize].descriptionSize} leading-relaxed line-clamp-3`}>
                            {designState.customDescription}
                          </p>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {designState.customTags.map((tag, index) => (
                            <span key={index} className="text-xs bg-gray-700/80 text-gray-300 px-3 py-1.5 rounded-full font-medium hover:bg-gray-600/80 transition-colors">
                              {tag}
                            </span>
                          ))}
                        </div>
        ...
        <SectionWrapper className="bg-gray-50 dark:bg-gray-900">
          <Container>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              {/* Safe Theme Card - Improved Layout */}
                ...
                <div className="bg-gray-800 p-6 border border-gray-600 hover:border-gray-500 transition-all duration-300 group cursor-pointer relative overflow-hidden flex flex-col hover:scale-105 hover:shadow-2xl h-80"
                  ...
                  <div className="relative z-10 flex items-start justify-between mb-6">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex flex-col">
                        <span className="text-sm font-semibold text-white">BE SAFE</span>
                        <span className="text-xs text-gray-400">General</span>
                      </div>
                    </div>
                    <span className="px-3 py-1.5 text-xs font-semibold rounded-full bg-red-100 text-red-800 dark:bg-red-900/20 dark:text-red-400 shadow-sm">
                      Advanced
                    </span>
                  </div>
                  ...
                  <div className="relative z-10 flex-1 flex flex-col space-y-4">
                    ...
                    {/* Tags Section - Better layout */}
                    <div className="flex flex-wrap gap-2">
                      <span className="text-xs bg-gray-700/80 text-gray-300 px-3 py-1.5 rounded-full font-medium hover:bg-gray-600/80 transition-colors">
                        privacy
                      </span>
                      <span className="text-xs bg-gray-700/80 text-gray-300 px-3 py-1.5 rounded-full font-medium hover:bg-gray-600/80 transition-colors">
                        security
