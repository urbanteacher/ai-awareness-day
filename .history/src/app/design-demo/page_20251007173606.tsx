                  ...
                  {designState.cardVariation === 0 && (
                    ...
                    <div className="bg-gray-800 p-6 border border-gray-600 hover:border-gray-500 transition-all duration-300 group cursor-pointer relative overflow-hidden flex flex-col hover:scale-105 hover:shadow-2xl"
                      ...
                      <div className="relative z-10 flex items-start justify-between mb-4">
                        ...
                        <span className={`px-2 py-1 text-xs font-medium ${designState.difficultyLevel === 0 ? 'rounded-none' : 'rounded-full'} ${difficultyLevels[designState.difficultyLevel].className}`}>
                       ...
                       {/* Activity Content */}
                       <div className="relative z-10 flex-1 flex flex-col">
                         {/* Body text at the top */}
                         <div className="space-y-3 flex-1">
                           <p className={`text-white ${cardSizes[designState.cardSize].descriptionSize} leading-relaxed line-clamp-3`}>
                             {designState.customDescription}
                           </p>
                           <h4 className={`${cardSizes[designState.cardSize].titleSize} font-bold text-white group-hover:text-purple-300 transition-colors leading-tight h-16 flex items-start`}>
                             <span className="line-clamp-2">{designState.customTitle}</span>
                           </h4>
                         </div>

                         {/* Activity Meta - General and Tags capped to 3 lines */}
                         <div className="mt-4 space-y-2">
                           <div className="flex items-center space-x-2">
                             <span className="text-xs text-gray-400">General</span>
                           </div>
                           
                           <div className="flex flex-wrap gap-1 line-clamp-3">
                  ...
                  {designState.cardVariation === 4 && (
                    ...
                    <div className="bg-white/10 backdrop-blur-md p-6 border border-white/20 hover:border-white/30 transition-all duration-300 group cursor-pointer relative overflow-hidden flex flex-col hover:scale-105 hover:shadow-2xl"
                      ...
                      <div className="relative z-10 flex items-start justify-between mb-4">
                        ...
                        <span className={`px-2 py-1 text-xs font-medium ${designState.difficultyLevel === 0 ? 'rounded-none' : 'rounded-full'} ${difficultyLevels[designState.difficultyLevel].className} backdrop-blur-sm`}>
                          {difficultyLevels[designState.difficultyLevel].name}
                        </span>
                      </div>
                  ...
                  {designState.cardVariation === 5 && (
                    ...
                    <div className="bg-gray-900 p-6 border-2 border-transparent hover:border-purple-500/50 transition-all duration-300 group cursor-pointer relative overflow-hidden flex flex-col hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/25"
                      ...
                      <div className="relative z-10 flex items-start justify-between mb-4">
                        ...
                        <span className={`px-2 py-1 text-xs font-medium ${designState.difficultyLevel === 0 ? 'rounded-none' : 'rounded-full'} ${difficultyLevels[designState.difficultyLevel].className} group-hover:shadow-lg group-hover:shadow-${difficultyLevels[designState.difficultyLevel].color}-500/50`}>
                          {difficultyLevels[designState.difficultyLevel].name}
                        </span>
                      </div>
                  ...
                  {designState.cardVariation === 7 && (
                    ...
                    <div className="bg-gray-800 p-6 border border-gray-600 hover:border-gray-500 transition-all duration-300 group cursor-pointer relative overflow-hidden flex flex-col hover:scale-105 hover:shadow-2xl"
                      ...
                      <div className="relative z-10 flex items-start justify-between mb-4">
                        ...
                        <span className={`px-2 py-1 text-xs font-medium ${designState.difficultyLevel === 0 ? 'rounded-none' : 'rounded-full'} ${difficultyLevels[designState.difficultyLevel].className} group-hover:animate-bounce`}>
                          {difficultyLevels[designState.difficultyLevel].name}
                        </span>
                      </div>
                  ...
                  {designState.cardVariation === 9 && (
                    ...
                    <div className="bg-gray-800 p-6 border border-gray-600 hover:border-gray-500 transition-all duration-300 group cursor-pointer relative overflow-hidden flex flex-col hover:scale-105 hover:shadow-2xl transform hover:-translate-y-2"
                      ...
                      <div className="relative z-10 flex items-start justify-between mb-4">
                        ...
                        <span className={`px-2 py-1 text-xs font-medium ${designState.difficultyLevel === 0 ? 'rounded-none' : 'rounded-full'} ${difficultyLevels[designState.difficultyLevel].className} shadow-lg`}>
                          {difficultyLevels[designState.difficultyLevel].name}
                        </span>
                      </div>
                  ...
                  {designState.cardVariation === 10 && (
                    ...
                    <div className="bg-gray-800 p-0 border border-gray-600 hover:border-gray-500 transition-all duration-300 group cursor-pointer relative overflow-hidden flex flex-col hover:scale-105 hover:shadow-2xl"
                      ...
                      >
                        ...
                        {/* Title in theme section */}
                        <h4 className={`${cardSizes[designState.cardSize].titleSize} font-bold text-white leading-tight relative z-10`}>
                          <span className="line-clamp-2">{designState.customTitle}</span>
                        </h4>
                      </div>
        ...
        <SectionWrapper className="bg-gray-50 dark:bg-gray-900">
          <Container>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                  ...
                  <div className="relative z-10 flex items-start justify-between mb-4">
                   ...
                   <div className="relative z-10 flex-1 flex flex-col">
                     ...
                     <div className="space-y-3 flex-1">
                       ...
                       <h4 className="text-xl font-bold text-white group-hover:text-purple-300 transition-colors leading-tight h-16 flex items-start">
              ...
              <SectionCard className="overflow-hidden">
                <div className="bg-gray-800 p-6 border border-gray-600 hover:border-gray-500 transition-all duration-300 group cursor-pointer relative overflow-hidden flex flex-col hover:scale-105 hover:shadow-2xl h-80"
                  ...
                  <div className="relative z-10 flex items-start justify-between mb-4">
                    ...
                    <span className="px-2 py-1 text-xs font-medium rounded-none bg-white text-green-600 dark:bg-green-900/20 dark:text-green-400">
                      Beginner
                    </span>
                  </div>
                  <div className="relative z-10 flex-1 flex flex-col">
              ...
              {/* Split + Image Card */}
              <SectionCard className="overflow-hidden">
                <div className="bg-gray-800 p-0 border border-gray-600 hover:border-gray-500 transition-all duration-300 group cursor-pointer relative overflow-hidden flex flex-col hover:scale-105 hover:shadow-2xl h-80">
                  {/* Left side - Theme section with image */}
                  <div className="flex-1 bg-gradient-to-br from-purple-500 to-pink-500 p-6 relative overflow-hidden">
                    {/* Background image overlay */}
                    <div 
                      className="absolute inset-0 bg-cover bg-center opacity-20 group-hover:opacity-30 transition-opacity duration-300"
                      style={{
                    ...
                    {/* Title in theme section */}
                    <h4 className="text-lg font-bold text-white leading-tight relative z-10">
                      <span className="line-clamp-2">Split + Image Design</span>
                    </h4>
                  </div>
                  ...
                  <div className="bg-gray-800 p-6 flex-1 flex flex-col">
                    {/* Difficulty badge */}
                    <div className="flex justify-end mb-4">
                      <span className="px-2 py-1 text-xs font-medium rounded-none bg-white text-green-600">Beginner</span>
                    </div>

                    {/* Description */}
                    <div className="flex-1">
                      <p className="text-white text-sm leading-relaxed line-clamp-3">
                        Split design combined with image content inside
                      </p>
                    </div>
                ...
                <div className="p-4">
                  <h4 className="font-semibold mb-2">Split + Image (Purple)</h4>
                  <p className="text-sm text-muted-foreground">Split design combined with image content inside</p>
                </div>
              </SectionCard>
            </div>
          </Container>
