...
| JS | `assets/js/main.js` | Animations, nav toggle, contact form AJAX, resource answers toggle |
| Demo resources importer | `functions.php` (admin, Resources submenu) | Adds **Resources → Import demo resources** screen that lets admins upload a WXR export of `resource` posts and import demo content using the WordPress Importer plugin. |
