...
<main id="main" role="main" class="resources-archive">
    <section class="section" style="padding-top: 100px;">
        <div class="container">
            ...
            <p class="section-desc"><?php esc_html_e( 'Lesson starters, lesson activities, and assembly materials for AI Awareness Day.', 'ai-awareness-day' ); ?></p>
                            ...
                            <a href="<?php echo esc_url( $url ); ?>" class="theme-link">
                                <?php if ( $theme_badge_src ) : ?>
                                    <span class="theme-link__badge">
                                        <img src="<?php echo esc_url( $theme_badge_src ); ?>" alt="" class="theme-link__badge-img" />
                                    </span>
                                <?php endif; ?>
            ...
            <div class="resource-filters fade-up">
                ...
                <form method="get" class="resource-filter-form" action="<?php echo esc_url( $filter_form_action ); ?>">
                    ...
                    <div class="resource-filter-group">
                        <label for="key_stage" class="resource-filter-label"><?php esc_html_e( 'Key stage', 'ai-awareness-day' ); ?></label>
                    ...
                    <div class="resource-filter-group resource-filter-group--submit">
                        ...
                        <a href="<?php echo esc_url( get_post_type_archive_link( 'resource' ) ?: home_url( '/resources/' ) ); ?>" class="resource-filters-clear resource-filter-submit"><?php esc_html_e( 'Clear filters', 'ai-awareness-day' ); ?></a>
                    </div>
                </form>
            </div>
                                ...
                                <?php if ( $has_overlay ) : ?>
                                    <div class="resource-card__image-overlay" aria-hidden="true">
                                        <div class="resource-card__image-top">
                                            <?php if ( $type_name ) : ?>
                                                <span class="resource-card__pill resource-card__pill--type"><?php echo esc_html( $type_name ); ?></span>
                                            <?php endif; ?>
                                            <?php if ( $theme_name ) : ?>
                                                <?php
                                                $principles_config = function_exists( 'aiad_principles_config' ) ? aiad_principles_config() : array();
                                                $principle_slugs   = ! empty( $principles_config ) ? array_keys( $principles_config ) : array( 'safe', 'smart', 'creative', 'responsible', 'future' );
                                                $theme_slug        = strtolower( $theme_name );
                                                $pill_class        = 'resource-card__pill--theme';
                                                if ( in_array( $theme_slug, $principle_slugs, true ) ) {
                            ...
                            <div class="resource-card__body">
                                ...
                                <p class="resource-card__action">
                                    <?php if ( $download_url ) : ?>
                                        ...
                                        <a href="<?php echo esc_url( $download_url ); ?>" class="resource-card__link resource-download-link" data-resource-id="<?php echo esc_attr( (string) get_the_ID() ); ?>" download target="_blank" rel="noopener"><?php echo esc_html( $download_label ); ?> →</a>
                                    <?php else : ?>
            ...
            if ( $from_partners_url ) :
                ...
                <div class="featured-from-orgs featured-from-orgs--teaser">
                    ...
                    <p class="section-desc"><?php esc_html_e( 'Interactive AI games and learning tools from trusted partners. Filter by type, theme and session length on the dedicated page.', 'ai-awareness-day' ); ?></p>
                    <p class="featured-from-orgs__cta">
                        <a href="<?php echo esc_url( $from_partners_url ); ?>" class="resource-filter-submit featured-from-orgs__cta-btn"><?php esc_html_e( 'Browse resources from partners', 'ai-awareness-day' ); ?></a>
                    </p>
                </div>
            <?php endif; ?>
        </div>
