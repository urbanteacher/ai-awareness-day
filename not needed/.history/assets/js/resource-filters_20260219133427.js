...
(function () {
    ...
    function themePillClass( themeSlug ) {
        if ( ! themeSlug ) return 'resource-card__pill resource-card__pill--theme';
    ...
    function renderCard( resource ) {
        ...
        var imgHtml = resource.thumbnail
            ? '<img src="' + escapeHtml( resource.thumbnail ) + '" class="resource-card__image" alt="" />'
        ...
        var actionHtml = '';
        // Always use a consistent CTA label for cards.
        if ( isExternal ) {
