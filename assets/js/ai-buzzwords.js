(function () {
	...
	function quizScoreMessage(score) {
		if (score >= 5) {
			return 'Brilliant — you know your 2027 AI vocabulary.';
		}
		if (score >= 4) {
