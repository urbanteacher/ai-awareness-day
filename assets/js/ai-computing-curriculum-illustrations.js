...
(function (global) {
	...
	function escAccent(c) {
		return /^#[0-9A-Fa-f]{6}$/.test(c || '') ? c : '#006A7D';
	}
	...
	function svgShell(h, title, inner) {
		return (
			...
			h +
			'" fill="#231F20"/>' +
			'<text x="160" y="18" text-anchor="middle" fill="#54504E" font-size="10" font-weight="600" font-family="system-ui,sans-serif">' +
			title +
			'</text>' +
			inner +
			'</svg>'
	...
	function card(x, y, w, h, label, a, hi, opts) {
		opts = opts || {};
		var fill = hi ? escAccent(a) : '#231F20';
		var stroke = hi ? '#F6F4ED' : opts.warn ? '#A32D2D' : '#54504E';
		...
		lines.forEach(function (line, i) {
			s +=
				...
				'" y="' +
				(ty + i * 14) +
				'" text-anchor="middle" fill="#F6F4ED" font-size="' +
				fs +
				'" font-weight="' +
				(hi ? '700' : '600') +
		...
		if (opts.num) {
			s +=
				...
				'" y="' +
				(y + 14) +
				'" text-anchor="middle" fill="#F6F4ED" font-size="10" font-weight="700" font-family="system-ui">' +
				opts.num +
				'</text>';
		}
		return s;
	...
	var CARD_SVG = {
		bebot: function (a) {
			...
			inner +=
				'<text x="160" y="128" text-anchor="middle" fill="#54504E" font-size="10" font-family="system-ui,sans-serif">Bee-Bot follows each instruction in order</text>';
		...
		'debug-order': function (a) {
			...
			inner +=
				'<text x="160" y="100" text-anchor="middle" fill="#A32D2D" font-size="11" font-weight="600" font-family="system-ui">Wrong order — fix the sequence</text>';
		...
		loop: function (a) {
			...
			inner +=
				...
				'" stroke-width="2"/>';
			inner +=
				'<text x="160" y="128" text-anchor="middle" fill="#54504E" font-size="10" font-family="system-ui">Runs the blocks inside again and again</text>';
		...
		'logic-bug': function (a) {
			...
			inner +=
				'<text x="160" y="44" text-anchor="middle" fill="#A32D2D" font-size="10" font-weight="700" font-family="system-ui">logic error</text>';
			inner +=
				'<text x="160" y="108" text-anchor="middle" fill="#54504E" font-size="10" font-family="system-ui">Program runs but wrong result</text>';
		...
		'if-then': function (a) {
			...
			inner +=
				'<text x="76" y="78" text-anchor="middle" fill="#63DF93" font-size="9" font-family="system-ui">yes</text>';
			inner +=
				'<text x="244" y="78" text-anchor="middle" fill="#54504E" font-size="9" font-family="system-ui">no</text>';
		...
		variable: function (a) {
			...
			inner +=
				'<text x="160" y="118" text-anchor="middle" fill="#54504E" font-size="10" font-family="system-ui">Variable stores data that can change</text>';
		...
		bubble: function (a) {
			...
			inner +=
				...
				'" stroke-width="2"/>';
			inner +=
				'<text x="160" y="128" text-anchor="middle" fill="#54504E" font-size="10" font-family="system-ui">Compare neighbours · swap if wrong order</text>';
		...
		binary: function (a) {
			...
			inner +=
				'<text x="160" y="108" text-anchor="middle" fill="#54504E" font-size="10" font-family="system-ui">Sorted list · check the middle each time</text>';
		...
		linear: function (a) {
			...
			inner +=
				'<text x="160" y="118" text-anchor="middle" fill="#54504E" font-size="10" font-family="system-ui">Check every name until found</text>';
		...
		'scales-justice': function (a) {
			...
			inner +=
				'<text x="160" y="128" text-anchor="middle" fill="#54504E" font-size="10" font-family="system-ui">Human review still matters</text>';
