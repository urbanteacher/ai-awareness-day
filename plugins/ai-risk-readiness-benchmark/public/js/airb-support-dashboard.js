...
(function () {
	...
	function peerComparisonHtml(model) {
		...
		var yourColor = peerYourScoreColor(yourScore, averageScore, topQuartile) || model.accent || '#A7350B';
	...
	function dependencyMetricHtml(metric, accent) {
		...
		var color = isDependency && pct != null ? dependencyIndexColor(pct) : (accent || '#A7350B');
	...
	function progressPanelHtml(model, opts) {
		...
		var accent = model.accent || '#A7350B';
