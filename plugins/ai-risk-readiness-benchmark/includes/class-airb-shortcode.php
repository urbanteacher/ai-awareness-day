		...
		wp_localize_script(
			...
			array(
				...
				'i18n'         => array(
					...
					'supportResultsTitle' => __( 'Education Support Staff Profile', 'ai-risk-benchmark' ),
					...
					'teacherResultsTitle'     => __( 'Teacher Benchmark results', 'ai-risk-benchmark' ),
					...
					'studentResultsTitle'   => __( 'Your AI learning results', 'ai-risk-benchmark' ),
