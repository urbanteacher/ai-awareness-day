		...
		wp_localize_script(
			...
			array(
				...
				'i18n'         => array(
					...
					'submit'         => __( 'Show my results', 'ai-risk-benchmark' ),
					...
					'contactEyebrow' => __( 'Final step', 'ai-risk-benchmark' ),
					'contactTitle'   => __( 'Personalise your results', 'ai-risk-benchmark' ),
					'contactHint'    => __( 'Everything below is optional. Add context for more relevant recommendations, or go straight to your results.', 'ai-risk-benchmark' ),
					'contactHintTeacher' => __( 'Everything below is optional. Add school context for more relevant teaching recommendations, or go straight to your results.', 'ai-risk-benchmark' ),
					...
					'requestSupportSupport' => __( 'Request support & resources', 'ai-risk-benchmark' ),
					'reportEmailSubject' => __( 'AI Awareness Day — support & guidance enquiry', 'ai-risk-benchmark' ),
					'reportEmailIntro' => __( 'Hello, I completed the free AI Risk & Readiness Benchmark and would like further support and guidance on improving our AI readiness, including how AI Awareness Day could help our school.', 'ai-risk-benchmark' ),
					'reportEmailRole' => __( 'Role', 'ai-risk-benchmark' ),
					'reportEmailClosing' => __( 'Please get in touch to discuss our benchmark results, next steps, and how the AI Awareness team can support our school.', 'ai-risk-benchmark' ),
					'copyResult'       => __( 'Copy result', 'ai-risk-benchmark' ),
					'copiedResult'     => __( 'Copied!', 'ai-risk-benchmark' ),
					'shareCopyIntro'   => __( 'I scored {score} on the AI Risk & Readiness Benchmark as a {role}{readiness}.', 'ai-risk-benchmark' ),
					'shareCopyBenchmarkAvg' => __( 'National average for {role}s: {avg}/100.', 'ai-risk-benchmark' ),
					'shareCopyBenchmarkPercentile' => __( 'That puts me ahead of {percentile}% of participants.', 'ai-risk-benchmark' ),
					'shareCopyTry'     => __( 'Try it: {url}', 'ai-risk-benchmark' ),
					...
					'shareResultsHintSupport' => __( 'Share your results with your line manager or AI lead to help build a whole-school picture of operational AI use.', 'ai-risk-benchmark' ),
					'supportResultsTitle' => __( 'Your results', 'ai-risk-benchmark' ),
					'supportResultsEyebrow' => __( 'Support staff · AI risk & readiness benchmark', 'ai-risk-benchmark' ),
					'supportRoleRisk' => __( 'Role-specific risk', 'ai-risk-benchmark' ),
					'supportRoleRiskSignal' => __( 'Higher in your role', 'ai-risk-benchmark' ),
					'supportOverallScores' => __( 'Overall scores', 'ai-risk-benchmark' ),
					'supportOverallIntro' => __( 'Headline scores for operations, oversight and data protection — detail follows below.', 'ai-risk-benchmark' ),
					'operationalDependency' => __( 'Operational Dependency Index', 'ai-risk-benchmark' ),
					'dataProtectionReadiness' => __( 'Data Protection Readiness', 'ai-risk-benchmark' ),
					'humanOversightRatio' => __( 'Human Oversight Ratio', 'ai-risk-benchmark' ),
					'shareDependencyIndex' => __( 'Share as image', 'ai-risk-benchmark' ),
					'shareDependencyIndexSharing' => __( 'Creating image…', 'ai-risk-benchmark' ),
					'shareDependencyIndexDone' => __( 'Image ready — check your downloads or share sheet.', 'ai-risk-benchmark' ),
					'shareDependencyIndexError' => __( 'Could not create image. Try again.', 'ai-risk-benchmark' ),
					'shareDependencyEyebrow' => __( 'AI Awareness Day · {role} benchmark', 'ai-risk-benchmark' ),
					'shareDependencyTagline' => __( 'Free AI Risk & Readiness Benchmark', 'ai-risk-benchmark' ),
					'shareDependencyShareText' => __( 'My AI Dependency Index from the AI Awareness Day benchmark: {pct}%.', 'ai-risk-benchmark' ),
					'shareSiteUrl'   => home_url( '/' ),
					'shareSiteLabel' => (string) wp_parse_url( home_url(), PHP_URL_HOST ),
					...
					'helpSupportHeading' => __( 'Further reading and tips to guide you', 'ai-risk-benchmark' ),
					'helpSupportHeadingShort' => __( 'Read more & tips', 'ai-risk-benchmark' ),
					'focusGuidanceToggle' => __( 'Tips & steps to try', 'ai-risk-benchmark' ),
					...
					'certificateUnlock' => __( 'Unlock certificate', 'ai-risk-benchmark' ),
					'certificateSubmitForReview' => __( 'Submit for review', 'ai-risk-benchmark' ),
					'certificateSubmittedForReview' => __( 'Submitted for review', 'ai-risk-benchmark' ),
					'certificateAllocated' => __( 'Certificate allocated', 'ai-risk-benchmark' ),
					'certificatePendingReview' => __( 'Submitted for review. We will email you when your certificate is approved.', 'ai-risk-benchmark' ),
					...
					'interestFormScrollError' => __( 'The request form could not be opened. Scroll to the bottom of your results or refresh the page and try again.', 'ai-risk-benchmark' ),
					...
					'statReadiness'  => __( 'Overall readiness', 'ai-risk-benchmark' ),
					'statReadinessNote' => __( 'From your role-specific audit domains — see breakdown below.', 'ai-risk-benchmark' ),
					...
					'statDepNote'    => __( 'Risk indicator — higher means greater reliance on AI.', 'ai-risk-benchmark' ),
					...
					'readinessBreakdown' => __( 'Readiness breakdown', 'ai-risk-benchmark' ),
					'riskIndicators' => __( 'Risk indicators', 'ai-risk-benchmark' ),
					'dependencyRisk' => __( 'AI Dependency Risk', 'ai-risk-benchmark' ),
					'teacherBenchmarkTitle'   => __( 'Teacher Benchmark', 'ai-risk-benchmark' ),
					'teacherResultsTitle'     => __( 'Your results', 'ai-risk-benchmark' ),
					'teacherOverallScores'    => __( 'Overall scores', 'ai-risk-benchmark' ),
					'teacherScoreBreakdown'   => __( 'Score breakdown', 'ai-risk-benchmark' ),
					'teacherBreakdownIntro'   => __( 'The same metrics as above — shown by domain and in detail.', 'ai-risk-benchmark' ),
					'teacherOverallIntro'     => __( 'Headline scores for your Teacher Benchmark — score breakdown follows below.', 'ai-risk-benchmark' ),
					'readinessScoreByDomain'  => __( 'Readiness score — by domain', 'ai-risk-benchmark' ),
					'riskScoreDetail'         => __( 'AI risk score & AI Dependency Index — detail', 'ai-risk-benchmark' ),
					'teacherBenchmarkRecap'   => __( 'Teacher Benchmark — score recap', 'ai-risk-benchmark' ),
					'statReadinessNoteTeacher'=> __( 'Overall score — see readiness breakdown below.', 'ai-risk-benchmark' ),
					'statRiskNoteTeacher'     => __( 'Inverse of readiness — see detail below.', 'ai-risk-benchmark' ),
					'statDepNoteTeacher'      => __( 'Same metric as in score recap below.', 'ai-risk-benchmark' ),
					'parentScores'   => __( 'Your scores', 'ai-risk-benchmark' ),
					'parentBenchmarkTitle' => __( 'Parent benchmark comparison', 'ai-risk-benchmark' ),
					'parentAverage'          => __( 'Average parent', 'ai-risk-benchmark' ),
					'parentConfidence'       => __( 'Homework Oversight Score', 'ai-risk-benchmark' ),
					'alignment'      => AIRB_Scoring::alignment_score_label(),
					'dfeAlignment'   => AIRB_Scoring::alignment_score_label(),
					'statDfeNote'    => AIRB_Scoring::alignment_score_disclaimer(),
					'alignmentDisclaimer' => AIRB_Scoring::alignment_score_disclaimer(),
					...
					'roleSupportStaff' => __( 'Support staff', 'ai-risk-benchmark' ),
					'roleStudent'    => __( 'Students', 'ai-risk-benchmark' ),
					'roleParent'     => __( 'Parents', 'ai-risk-benchmark' ),
					'studentBenchmarkTitle' => __( 'Students like you', 'ai-risk-benchmark' ),
					'studentAverage'        => __( 'Average students', 'ai-risk-benchmark' ),
					'studentTopQuartile'    => __( 'Top quartile students', 'ai-risk-benchmark' ),
					'studentTopQuartileShort' => __( 'Top quartile', 'ai-risk-benchmark' ),
					'studentPeerComparison' => __( 'How you compare to other students', 'ai-risk-benchmark' ),
					'peerComparisonShort'   => __( 'How you compare', 'ai-risk-benchmark' ),
					'peerYou'               => __( 'You', 'ai-risk-benchmark' ),
					'peerGapBelowAverage'   => __( '{n} points below average', 'ai-risk-benchmark' ),
					'peerGapAboveAverage'   => __( '{n} points above average', 'ai-risk-benchmark' ),
					'peerGapAtAverage'      => __( 'In line with average', 'ai-risk-benchmark' ),
					'peerGapBelowTop'       => __( '{n} points below top quartile', 'ai-risk-benchmark' ),
					'peerGapBelowTopShort'  => __( '{n} below top quartile', 'ai-risk-benchmark' ),
					'peerGapAboveTop'       => __( '{n} points above top quartile', 'ai-risk-benchmark' ),
					'peerGapAtTop'          => __( 'In line with top quartile', 'ai-risk-benchmark' ),
					'whereYouStand'         => __( 'Where you stand', 'ai-risk-benchmark' ),
					'studentPeerEstimated'  => __( 'Comparison uses reference benchmarks until enough students have completed the audit.', 'ai-risk-benchmark' ),
					'studentPeerPercentile' => __( 'You scored higher than {n}% of students who completed this benchmark.', 'ai-risk-benchmark' ),
					'teacherPeerComparison' => __( 'How you compare to other teachers', 'ai-risk-benchmark' ),
					'teacherNationalAverage'  => __( 'National average', 'ai-risk-benchmark' ),
					'teacherNationalAverageShort' => __( 'Nat. avg', 'ai-risk-benchmark' ),
					'teacherTopQuartileShort' => __( 'Top quartile', 'ai-risk-benchmark' ),
					'teacherPeerEstimated'  => __( 'Comparison uses reference benchmarks until enough teachers have completed the audit.', 'ai-risk-benchmark' ),
					'teacherPeerPercentile' => __( 'You scored higher than {n}% of teachers who completed this benchmark.', 'ai-risk-benchmark' ),
					'studentResultsTitle'   => __( 'Your learning profile', 'ai-risk-benchmark' ),
					'studentResultsEyebrow' => __( 'Student · AI skills benchmark', 'ai-risk-benchmark' ),
					'studentSkillLevel'     => __( 'Overall AI skills level', 'ai-risk-benchmark' ),
					'studentAddSchool'      => __( 'Add your school', 'ai-risk-benchmark' ),
					'studentRetake'         => __( 'Retake the benchmark', 'ai-risk-benchmark' ),
					'studentRetakeAtRiskHeading' => __( 'Needs attention — build your skills first', 'ai-risk-benchmark' ),
					'studentRetakeAtRiskBody' => __( 'You scored below 35%, which puts you in the at-risk band. Explore the articles and study resources above before you retake — they are chosen to help you improve the areas that matter most.', 'ai-risk-benchmark' ),
					'studentRetakeBody'     => __( 'When you are ready, retake the benchmark to see how your AI skills have improved.', 'ai-risk-benchmark' ),
					'studentSchoolHint'     => __( 'Optional — helps your school unlock a whole-school student AI report when enough pupils take part.', 'ai-risk-benchmark' ),
					'parentResultsTitle'    => __( 'Your home AI picture', 'ai-risk-benchmark' ),
					'parentResultsEyebrow'  => __( 'Parent / carer · AI awareness benchmark', 'ai-risk-benchmark' ),
					'parentAwarenessLevel'  => __( 'Overall home AI awareness', 'ai-risk-benchmark' ),
					'parentShareSchool'     => __( 'Share with school', 'ai-risk-benchmark' ),
					'parentSafetyGuide'     => __( 'Parent safety guide', 'ai-risk-benchmark' ),
					'statLearningReadiness' => __( 'Learning readiness', 'ai-risk-benchmark' ),
					'independentThinking'     => __( 'Independent Thinking', 'ai-risk-benchmark' ),
					'journeyCurrent'        => __( 'Current', 'ai-risk-benchmark' ),
					'journeyNext'           => __( 'Next', 'ai-risk-benchmark' ),
					'guidedImprovement'     => __( 'Your priority next step', 'ai-risk-benchmark' ),
					'schoolSnapshotTitle' => __( 'Whole-School AI Readiness Snapshot', 'ai-risk-benchmark' ),
					'schoolSnapshotGroups' => __( '{complete} of {total} stakeholder groups complete', 'ai-risk-benchmark' ),
					'schoolHighestRisk' => __( 'Highest risk areas', 'ai-risk-benchmark' ),
					'schoolPriorities' => __( 'Recommended school priorities', 'ai-risk-benchmark' ),
					'schoolExposureDetails' => __( 'Full exposure breakdown', 'ai-risk-benchmark' ),
					'schoolSnapshotIncomplete' => __( 'Roll out the benchmark to all five stakeholder groups for a complete whole-school picture.', 'ai-risk-benchmark' ),
					'schoolSnapshotLoading' => __( 'Loading whole-school snapshot…', 'ai-risk-benchmark' ),
					...
					'readinessScaleAria'     => __( 'Overall benchmark readiness {score} out of 100, {band}', 'ai-risk-benchmark' ),
					'earlyEstablishedNote'   => __( 'Early established — strong foundation with room to reach full Established (65%+).', 'ai-risk-benchmark' ),
					'governanceMaturity' => AIRB_Scoring::governance_maturity_label(),
					'biasReadiness' => AIRB_Scoring::bias_readiness_label(),
					...
					'policyGen'      => __( 'AI Policy', 'ai-risk-benchmark' ),
					...
					'leaderProfilePhaseRequired' => __( 'Please select your school type to continue.', 'ai-risk-benchmark' ),
					'leaderProfilePhaseNote' => __( 'Questions use plain language — you do not need to know policy acronyms.', 'ai-risk-benchmark' ),
					'continueAudit' => __( 'Continue to audit', 'ai-risk-benchmark' ),
					...
					'schoolOptionalHint' => __( 'This can also group anonymous responses if your school later takes part.', 'ai-risk-benchmark' ),
					'contactPrivacyNote' => __( 'No pupil names or personal pupil data. Leave everything blank to continue without sharing details.', 'ai-risk-benchmark' ),
					...
					'benchmark'      => array(
						...
						'sampleNote'     => __( 'Based on {n} submissions for your role. Updated live as more schools take part.', 'ai-risk-benchmark' ),
					),
				),
				'interestPrefillMap' => AIRB_Interest::gateway_prefill_map(),
				'interestForms'      => array(
					'teacher'       => AIRB_Interest::form_shell_for_frontend( 'teacher' ),
					'leader'        => AIRB_Interest::form_shell_for_frontend( 'leader' ),
