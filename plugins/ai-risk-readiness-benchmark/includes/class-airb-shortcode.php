		...
		wp_localize_script(
			...
			array(
				...
				'i18n'         => array(
					...
					'chooseRoleHeading' => __( 'Choose your role in school — click a card below to start your free audit', 'ai-risk-benchmark' ),
					...
					'shareOversightGauge' => __( 'Share as image', 'ai-risk-benchmark' ),
					'shareOversightGaugeSharing' => __( 'Creating image…', 'ai-risk-benchmark' ),
					'shareOversightGaugeDone' => __( 'Image ready — check your downloads or share sheet.', 'ai-risk-benchmark' ),
					'shareOversightGaugeError' => __( 'Could not create image. Try again.', 'ai-risk-benchmark' ),
					'shareOversightEyebrow' => __( 'AI Awareness Day · {role} benchmark', 'ai-risk-benchmark' ),
					'shareOversightTagline' => __( 'Free AI Risk & Readiness Benchmark', 'ai-risk-benchmark' ),
					'shareOversightShareText' => __( 'My Human Oversight Ratio from the AI Awareness Day benchmark: {pct}% — {band}.', 'ai-risk-benchmark' ),
					...
					'studentRetakeAtRiskHeading' => __( 'At risk — build your skills first', 'ai-risk-benchmark' ),
