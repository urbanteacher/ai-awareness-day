		...
		wp_localize_script(
			...
			array(
				...
				'i18n'         => array(
					...
					'consentBenchmark' => __( 'Store my results anonymously to improve national benchmarks', 'ai-risk-benchmark' ),
					'consentBenchmarkHint' => __( 'Optional. Helps build the national AI readiness picture. You can still see your results if you leave this unchecked.', 'ai-risk-benchmark' ),
					'consentContact' => __( 'Contact me about support and next steps', 'ai-risk-benchmark' ),
					...
					'parentConfidence'       => __( 'Parent Confidence', 'ai-risk-benchmark' ),
					...
					'schoolSnapshotIncomplete' => __( 'Roll out the benchmark to all four groups for a complete whole-school picture.', 'ai-risk-benchmark' ),
