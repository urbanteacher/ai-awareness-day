 ...
 *
 * Usage (from WordPress root): wp eval-file wp-content/plugins/ai-risk-readiness-benchmark/bin/export-copy-tiers-json.php
 *
 * @package AIRB
 */
...
if ( ! defined( 'ABSPATH' ) ) {
	...
	define( 'AIRB_PLUGIN_DIR', dirname( __DIR__ ) . '/' );
