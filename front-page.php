        ...
        <section class="hero-section <?php echo esc_attr($text_alignment_class); ?>" id="hero">
            <div class="container">
                ...
                <div class="hero-title-block fade-up">
                    <p class="hero-date">
                        <?php echo esc_html(aiad_get_theme_mod_default('aiad_hero_date', aiad_get_customizer_defaults()['aiad_hero_date'])); ?>
                    </p>
                    <div class="hero-logo">
                        <?php
                        ...
                        ?>
                        <p class="hero-slogan">
                            <?php echo esc_html(aiad_get_theme_mod_default('aiad_hero_slogan', $defaults['aiad_hero_slogan'])); ?>
                        </p>
                        <p class="section-desc">
                            <?php echo esc_html(aiad_get_theme_mod_default('aiad_hero_subtitle', $defaults['aiad_hero_subtitle'])); ?>
                        </p>
                    </div>
                </div>
                ...
                <div class="campaign-split<?php echo $campaign_has_embed ? '' : ' campaign-split--single'; ?>">
                    <div class="campaign-content fade-up">
                        ...
                        <h2 class="section-title">
                            <?php echo esc_html(aiad_get_theme_mod_default('aiad_campaign_title', $defaults['aiad_campaign_title'])); ?>
                        </h2>
                        <p class="section-desc">
                            <?php echo wp_kses_post(aiad_get_theme_mod_default('aiad_campaign_text', $defaults['aiad_campaign_text'])); ?>
                        </p>
                        <p class="section-desc">
                            <?php echo wp_kses_post(aiad_get_theme_mod_default('aiad_campaign_text_2', $defaults['aiad_campaign_text_2'])); ?>
                        </p>
                    </div>
                    <?php if ($campaign_has_embed): ?>
                        <div class="campaign-embed fade-up">
                            <div class="campaign-embed__wrapper">
                                <iframe src="<?php echo esc_url($campaign_embed_src); ?>" height="399" width="504"
                ...
                <div id="reach" class="momentum-section fade-up"
                    ...
                    <div class="partners-grid">
                        ...
                        foreach ($partners as $index => $partner):
                            ...
                            ?>
                            <div class="partner-card fade-up stagger-<?php echo $index + 1; ?> <?php echo $is_hidden ? 'partner-card--hidden' : ''; ?>"
                        ...
                        <a href="#contact"
                            ...
                            <p class="partner-stats">
                                <?php esc_html_e('Complete form to join movement', 'ai-awareness-day'); ?></p>
                        </a>
                    </div>
                    ...
                    <?php if ($partners_count > $initial_show): ?>
                        <div class="partners-reveal-wrapper" style="text-align: center; margin-top: 2.5rem;">
                            <button type="button" class="partners-reveal-btn" id="partners-reveal-btn">
                                <span
                                    class="reveal-text"><?php esc_html_e('Show More Partners', 'ai-awareness-day'); ?></span>
                                <span class="hide-text"
                                    style="display: none;"><?php esc_html_e('Show Less', 'ai-awareness-day'); ?></span>
    ...
    <?php if (aiad_is_section_visible('toolkit')): ?>
        <section class="section <?php echo esc_attr($text_alignment_class); ?>" id="toolkit">
            ...
            <div id="display-board" class="toolkit-display-board fade-up"
                ...
                <h2 class="section-title">
                    <?php esc_html_e('Create a display board for your school', 'ai-awareness-day'); ?></h2>
                <p class="section-desc">
                    ...
                    <div class="display-board-submit__content">
                        <div class="display-board-submit__text">
                            <h3 class="display-board-steps__title">
                                <?php esc_html_e('Submit your display board', 'ai-awareness-day'); ?></h3>
                            <p class="section-desc">
                ...
                if ($display_img_2_url || $display_img_3_url):
                    ...
                    <div class="display-board-examples" hidden>
                        <h3 class="display-board-examples__title">
                            <?php esc_html_e('More example display boards', 'ai-awareness-day'); ?></h3>
                            ...
                            <?php if ($display_img_2_url): ?>
                                <figure class="display-board-examples__item">
                                    <img src="<?php echo esc_url($display_img_2_url); ?>"
                                        alt="<?php esc_attr_e('Example display board 2', 'ai-awareness-day'); ?>"
                                        loading="lazy" />
                                </figure>
                            <?php endif; ?>
                            <?php if ($display_img_3_url): ?>
                                <figure class="display-board-examples__item">
                                    <img src="<?php echo esc_url($display_img_3_url); ?>"
                                        alt="<?php esc_attr_e('Example display board 3', 'ai-awareness-day'); ?>"
                                        loading="lazy" />
                                </figure>
                            <?php endif; ?>
                        </div>
            ...
            <div id="themes" class="toolkit-explore-themes"
                ...
                if ($theme_terms && !is_wp_error($theme_terms)):
                    ...
                    <p class="explore-subheading"
                        ...
                        <?php esc_html_e('By theme', 'ai-awareness-day'); ?></p>
                ...
                if (!empty($session_cards)):
                    ...
                    <p class="explore-subheading"
                        ...
                        <?php esc_html_e('By session length', 'ai-awareness-day'); ?></p>
                            ...
                            <article class="resource-card resource-card--external fade-up">
                                ...
                                <div class="resource-card__body">
                                    ...
                                    <?php if ($duration_name): ?>
                                        <span
                                            class="duration-badge duration-badge--card"><?php echo esc_html($duration_name); ?></span>
                                    <?php endif; ?>
                                    <h2 class="resource-card__title">
                    ...
                    <a href="<?php echo esc_url($linkedin_post_url); ?>" class="linkedin-card" target="_blank"
                        ...
                        <div class="linkedin-card__content">
                            <h2 id="linkedin-post-title" class="linkedin-card__title">
                                <?php esc_html_e('Latest from LinkedIn', 'ai-awareness-day'); ?></h2>
            ...
            <div class="container">
                <div class="contact-wrapper">
                    ...
                    <div class="contact-info fade-up">
                        ...
                        ?>
                        <h2 class="section-title">
                            <?php echo esc_html(aiad_get_theme_mod_default('aiad_contact_title', $defaults['aiad_contact_title'])); ?>
                        </h2>
                        <p class="section-desc">
                            <?php echo wp_kses_post(aiad_get_theme_mod_default('aiad_contact_desc', $defaults['aiad_contact_desc'])); ?>
                        </p>
                    </div>
                        ...
                        <form id="aiad-contact-form" novalidate>
                            <div class="form-group">
                                ...
                                <select id="involved_as" name="involved_as" required aria-describedby="involved_as-desc">
                                    ...
                                    <option value="school_leader">
                                        <?php esc_html_e('School leader', 'ai-awareness-day'); ?></option>
                            ...
                            <div class="form-group form-group-role contact-checklist" data-role="teacher"
                                ...
                                <p class="form-label-optional">
                                    <?php esc_html_e('Optional – what are you interested in?', 'ai-awareness-day'); ?></p>
