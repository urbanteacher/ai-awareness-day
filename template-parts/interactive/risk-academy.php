	...
	<section class="sara-section sara-section--paper" id="sara-sources" data-sara-reveal>
		<div class="sara-wrap">
			...
			<ul class="sara-sources-list">
				...
				<li><a href="https://www.gov.uk/government/publications/generative-ai-product-safety-standards" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'DfE — Generative AI: product safety standards', 'ai-awareness-day' ); ?></a></li>
