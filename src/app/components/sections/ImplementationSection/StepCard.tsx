...
export function StepCard({ 
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative bg-gray-800 text-white transition-all duration-300 hover:scale-105 hover:shadow-xl h-full group",
        ...
        >
          <div className={cn(
            ...
            <div className="absolute top-3 left-4">
              <div className="px-3 py-1 rounded-full bg-white/30 dark:bg-black/30 text-black dark:text-white text-xs font-bold">
                Step {step}
              </div>
            </div>
